...
function handleKeyPress(event) {
  ...
  function input_enter() {
      ...
      if (text === "help" || text === "list") {
          ...
          let commandList = "<div class=\"m1\">Directory:</div>" +
                            "<div class=\"m2\">history : My History</div>" +
                            "<div class=\"m2\">college : More About My College Life</div>" +
                            "<div class=\"m2\">current : My Current Life</div>" +
                            "<div class=\"m2\">gallery : My Gallery</div>" +
                            "<div class=\"m2\">back : Back to Home</div>" +
        ...
        let terminalElement = document.getElementById("terminal");
          ...
          let commandList = "<div class=\"m1\">Hi, I am Sahil Agrawal, currently studying Computer Science (6th Semester) at IIT Patna. For more information, visit: <a class=\"href\" href=\"/about.html\">About Me</a>.</div>"+
                            "<div class=\"m1\" style=\"border: 5px solid #color; padding: 10px; text-align: center;\">" +
